...
***I am looking for an individual or individuals to take over this project. The maintainer(s) would need to create their own Google Play and republish the applications due to signing certificates.***
